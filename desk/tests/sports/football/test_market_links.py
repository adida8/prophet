...
def _pick() -> Verdict:
    return Verdict(
        ...
        price="-145",
        edge_pp=4.2,
        market_url="https://polymarket.com/sports/fifa-world-cup/fifwc-fra-mex-2026-06-12",
        model_p=0.46,
        market_p=0.42,
    )
...
def test_polymarket_deep_link_for_wc26_slug() -> None:
    ...
    assert url == "https://polymarket.com/sports/fifa-world-cup/fifwc-fra-mex-2026-06-12"
